...
4. 在 **“编辑模板”** 边栏选项卡上，单击 **“加载文件”**，找到 **\\Allfiles\\Labs\\04\\az-500-04_azuredeploy.json** 文件并单击 **“打开”**。
...
7. 在 **“编辑参数”** 边栏选项卡上，单击 **“加载文件”**，找到 **\\Allfiles\\Labs\\04\\az-500-04_azuredeploy.parameters.json** 文件并单击 **“打开”**。

    >**备注**： 查看参数文件的内容，注意 adminUsername 和 adminPassword 值。

8. 在 **“编辑模板”** 边栏选项卡上，单击 **“保存”**。

9. 在 **“自定义部署”** 边栏选项卡上，确保已配置以下设置（其他设置保留为默认值）：
...
3. 在 **“创建租户”** 边栏选项卡的 **“基础”** 选项卡上，确保选中 **“Azure Active Directory”** 选项，然后单击 **“下一步: 配置 >”**。
...
2. 在“**目录 + 订阅**”边栏选项卡中，单击新创建的租户“**AdatumLab500-04**”，然后单击“**切换**”钮将其设置为当前目录。

    >**备注**： 如果 **AdatumLab500-04** 条目未出现在 **“目录+订阅”** 筛选器列表中，则可能需要你刷新浏览器窗口。

3. 在 Azure 门户页面顶部的“**搜索资源、服务和文档**”文本框中，键入“**Azure Active Directory**”，然后按 **Enter**。在“**AdatumLab500-04**”边栏选项卡上的“**管理**”部分，单击“**许可证**”。
...
4. 返回到“**用户 \| 所有用户(预览)**”边栏选项卡，单击“**+ 新建用户**”。 

5. 在 **“新建用户”** 边栏选项卡上，确保选择 **“创建用户”** 选项，并指定以下设置（保留所有其他设置的默认值）：
...
6. 返回到“**用户 \| 所有用户(预览)**”边栏选项卡，单击“**+ 新建用户**”。 
...
1. 在“**用户 \| 所有用户(预览)**”边栏选项卡，单击表示你的用户帐户的条目。 

2. 在显示用户帐户属性的边栏选项卡上，单击“**编辑**”。  如果未设置使用位置，请验证使用位置是否设置为“**美国**”，然后单击“**保存**”。

3. 导航回 **AdatumLab500-04** Azure Active Directory 边栏选项卡的 **“管理”** 部分，并单击 **“许可证”**。

4. 在 **“许可证 \| 概述”** 选项卡上，单击 **“所有产品”**，勾选 **“Azure Active Directory Premium P2”** 复选框，然后单击 **“+ 分配”**。

5. 在 **“分配许可证”** 边栏选项卡上，单击 **“+添加用户和组”**。

6. 在 **“用户”** 边栏选项卡上，选择 **aaduser1**、**aaduser2**、**aaduser3**，以及你的用户帐户，然后单击 **“选择”**。
...
3. 在 **“安全 \| 入门”** 边栏选项卡上的 **“管理”** 部分，单击 **“MFA”**。

4. 在 **“多重身份验证 \| 入门”** 边栏选项卡上，单击 **“其他基于云的 MFA 设置”** 链接。 
...
10. 单击 **“取消”**，然后切换回显示 Azure 门户中的 **“多重身份验证\| 入门”** 边栏选项卡的浏览器标签。

11. 在 **“设置”** 部分，单击 **“欺诈警报”**。

12. 在 **“多重身份验证 \| 欺诈警报”** 边栏选项卡中，配置以下设置：
...
9. 出现提示时，更改密码。确保记录新密码。

10. 验证是否已成功登录 Azure 门户。
...
3. 在 **“安全 \| 入门”** 边栏选项卡上，在 **“保护”** 部分，单击 **“条件访问”**。

4. 在“**条件访问 \| 策略**”选项卡上，单击“**+ 新建策略**”，从下拉列表中选择“**创建新策略**”。 

5. 在 **“新建”** 边栏选项卡上，配置以下设置：

   - 在 **“名称”** 文本框中，键入 **“AZ500Policy1”**
	
   - 单击“**选定的用户或工作负载标识**”。在右侧的“此策略适用对象”>“用户和组”>“包括”> 启用“**选择用户和组**”> 选中“**用户和组**”复选框下的“**选择**”边栏选项卡中，单击 **aaduser2**，然后单击“**选择**”。
...
14. 在 **“安全 \| 入门”** 边栏选项卡上，在 **“保护”** 部分，单击 **“条件访问”**。

15. 在 **“条件访问 \| 策略”** 边栏选项卡上，单击 **AZ500Policy1** 旁边的省略号，然后单击 **“删除”**，在提示确认时，单击 **“是”**。
...
3. 在 **“安全 \| 入门”** 边栏选项卡上，在 **“保护”** 部分，单击 **“标识保护”**。
...
3. 在 **“虚拟机”** 边栏选项卡，单击条 **目“az500-04-vm1”**。 

4. 在 **“az500-04-vm1”** 边栏选项卡，单击 **“连接”**，然后在下拉菜单中单击 **“RDP”**。 

5. 单击 **“下载 RDP 文件”** 并通过远程桌面将其连接到 **az500-04-vm1** Azure VM。当系统提示你进行验证时，请提供以下凭据：
...
9. 在 InPrivate Internet Explorer 窗口中，导航至 ToR 浏览器项目（网址为 [**https://www.torproject.org/projects/torbrowser.html.en**](https://www.torproject.org/projects/torbrowser.html.en)。

10. 使用默认设置下载并安装 Windows 版本的 ToR 浏览器。 

11. 安装完成后，启动 ToR 浏览器，使用初始页面中的 **“连接”** 选项，然后导航到应用程序访问面板（网址为 [**https://myapps.microsoft.com**](https://myapps.microsoft.com)

12. 出现提示时，尝试使用 **aaduser3** 帐户登录。 

    >**备注**： 将会显示**你的登录已被阻止**消息。这是意料之中的，因为此帐户没有配置多重身份验证，多重身份验证是必需的，因为使用 ToR 浏览器会增加登录风险。

13. 使用 **“注销并使用另一个帐户登录选项”** 登录，可以使用之前在本实验室中为多重身份验证创建和配置的帐户 **aaduser1** 登录。
...
3. 在 **“安全 \| 入门”** 边栏选项卡的 **“报告”** 部分，单击 **“风险用户”**。 

4. 查看报告并确定引用 **aaduser3** 用户帐户的条目。

5. 在 **“安全 \| 入门”** 边栏选项卡上，在 **“报告”** 部分，单击 **“风险登录”**。 
...
5. 在 **“标识保护 \| 用户风险策略”** 边栏选项卡上，将 **“执行策略”** 设置为 **“关闭”**，然后单击 **“保存”**。

6. 在 **“标识保护 \| 用户风险策略”** 边栏选项卡上，单击 **“登录风险策略”**

7. 在 **“标识保护 \| 登录风险策略”** 边栏选项卡上，将 **“执行策略”** 设置为 **“关闭”**，然后单击 **“保存”**。
...
3. 在 **“虚拟机”** 边栏选项卡，单击条目 **“az500-04-vm1”**。 
