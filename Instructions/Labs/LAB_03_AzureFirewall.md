...
6. 在“自定义部署”边栏选项卡上，确保已配置以下设置（其他设置保留默认值）：
   ...
   |位置|**（美国）美国东部**|
   |adminPassword|你自己为虚拟机选择的安全密码。 请记住密码。 稍后，你将需要它来连接 VM。|
...
3. 在“**创建防火墙**”边栏选项卡的“**基本信息**”选项卡上，指定以下设置： 
   ...
   |防火墙管理 NIC|若要禁用此功能，请**取消选择**“**启用防火墙管理 NIC**”选项。|
...
6. 在 Azure 门户页面顶部的“搜索资源、服务和文档”文本框中，键入“资源组”，然后按 Enter 键  。

7. 在“资源组”边栏选项卡上，在资源组列表中，单击“AZ500LAB08”条目。

    >**注意**：在“AZ500LAB08”资源组边栏选项卡上，查看资源列表。 你可以按“类型”排序 。

8. 在资源列表中，单击代表“Test-FW01”防火墙的条目。

9. 在“Test-FW01”边栏选项卡上，确定分配给防火墙的“专用 IP”地址。 
...
3. 在“**Srv-Work**”边栏选项卡上，单击“**网络**”。

4. 在“**Srv-Work \|网络设置**”边栏选项卡上，单击“**网络接口**”条目旁边的链接。
...
3. 在“Srv-Jump”边栏选项卡上，单击“连接”，然后在下拉菜单中单击“连接”************。 

4. 下载 RDP 文件，通过远程桌面将它连接到“Srv-Jump”**** Azure VM。 收到身份验证提示时，请提供以下凭据：

   |设置|值|
   |---|---|
   |用户名|localadmin|
   |密码|你在任务 1 步骤 6 中部署自定义模板期间选择的安全密码。|
