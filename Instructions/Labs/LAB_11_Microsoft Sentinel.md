...
![本实验室任务流程图的示意图。](../media/microsoft-sentinel-diagram.png)
...
9. 单击“基本设置”选项卡底部的“下一步”按钮两次，进入“参数”选项卡************。在“参数”选项卡上，单击“主要 Log Analytics 工作区(…)”按钮。******** 在“**主要 Log Analytics 工作区**”页面中，确保已选中你的订阅，并使用“**工作区**”下拉列表选择用于 Sentinel 的 Log Analytics 工作区。 完成操作后，单击页面底部的“选择”按钮。
