...
![显示此实验室中任务流程流的示意图。](../media/key-vault-diagram.png)
...
#### 安装 az500-10-DB.json 自定义模板

1. 在 Azure 门户页面顶部的“搜索资源、服务和文档”文本框中，键入“部署自定义模板”，然后按 Enter 键  。

2. 在“自定义部署”边栏选项卡中，单击“在编辑器中构建自己的模板”选项。

3. 在“编辑模板”边栏选项卡上，单击“加载文件”，找到 \Allfiles\Labs\10\az-500-10_DB.json 文件，并单击“打开”。****************

4. 确保已选择正确的资源组。

5. 将“管理员密码”设置为上一步所用的相同密码。****
...
9. 在“创建访问策略”边栏选项卡上，指定以下设置（所有其他设置保留默认值）： 
    ...
    |选择主体|在“主体”边栏选项卡上，选择你的用户帐户，然后单击“下一步”********|
    |应用程序（可选）|单击“下一步”|
    |查看 + 创建|单击“创建”|
...
4. 导航回“az500-10-vm1”边栏选项卡，单击“概述”，接着单击“连接”，然后在下拉菜单中单击“连接”。**************** 

5. 下载 RDP 文件，通过远程桌面将它连接到“az500-10-vm1”**** Azure VM。 收到身份验证提示时，请提供以下凭据：
...
- 任务 1：安装 Visutal Studio 2022
- 任务 2：运行数据驱动的应用程序，以演示在加密 Azure SQL 数据库的过程中如何使用 Azure 密钥保管库

#### 任务 1：安装 Visual Studio 2022

1. 切换到你的服务器虚拟机（如果你尚未切换到该虚拟机）。

2. 打开 “服务器管理器” 。

3. 选择“本地服务器”。

4. 将“IE 增强的安全配置”设置为“关”。********

5. 打开浏览器并绕过有关关闭 IE ESC 的警告。

6. 转到 https://visualstudio.microsoft.com/downloads。

7. 在“Visual Studio 2022”框中，在“Community”下选择“免费下载”。************
