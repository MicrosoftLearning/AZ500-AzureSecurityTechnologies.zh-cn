...
1. 在 **“添加访问策略”** 边栏选项卡上，指定以下设置（所有其他设置保留默认值）： 
    ...
    |----|----|
    |从模板配置（可选）|**密钥、机密和证书管理**|
    |密钥权限|单击“**全选**”，总共会**选中 16 个**权限（确保“**轮换策略操作**”的权限是“**未选中**”） |
...
1. 在 Azure 门户中，导航到**医疗** SQL 数据库边栏选项卡，在“**基本**”部分中，确定“**服务器名称**”（复制到剪贴板），然后在工具栏中单击“**设置服务器防火墙**”。  
...
**备注**：在进行加密时，如果引发了与 **Rotary(Microsoft.SQLServer.Management.ServiceManagement)** 相关的任何错误，如“**调用目标引发了异常**”，则确保未选中“**轮换策略操作**”的“**密钥权限**”值。如果不在 Azure 门户中，请导航到“**密钥保管库**”>>“**访问策略**”>>“**密钥权限**”>>“**取消选中‘轮换策略操作’下的所有值**”。 
...
1. 在“**对象资源管理器**”窗格，右键单击“**医疗**”数据库，然后在右键菜单中单击“**新建查询**”。
